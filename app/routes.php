...
Route::group(array('before' => 'auth'), function(){    
		...
		Route::get('member/{uri1}/{uri2}/{uri3}/{uri4}/{uri5}', array('as'=>'member', 'uses'=>'DashboardController@getMember'));
		...
		Route::post('mark-favorite', array('uses'=>'ProjectController@markFavorite'));
});
