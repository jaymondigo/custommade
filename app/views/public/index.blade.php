...
<!-- Mirrored from www.revox.io/frontend/index.html by HTTrack Website Copier/3.x [XR&CO'2013], Fri, 27 Dec 2013 00:03:23 GMT -->
			...
			<ul>
				...
				<li data-transition="fade" data-slotamount="5" data-masterspeed="700" >
					...
					<div class="tp-caption mediumlarge_light_white_center sft tp-resizeme slider"
							...
							<h1 class="text-white custom-font title ">Imagine. Collaborate. Create</h1>
							<p style=" font-size:32px !important;">When it matters, you should get it Custom Made.</p>
...
<div class="section ">
	<div class="container">
		<div class="p-t-40 p-b-40">
			<h2 class="text-center">BLOG <span class="semi-bold">impossible</span>, We’ve <span class="semi-bold">designed everything</span> beyond... <a href="#" class="btn btn-purple btn-lg  btn-large m-r-10">LEARN MORE</a></h2>
		</div>
	</div>
</div>	
<div class="section white ha-waypoint"  data-animate-down="ha-header-color" data-animate-up="ha-header-hide" >
		...
		<div class="col-md-12 feature-list ">
			...
			<h4 class="title">Choose a Maker</h4>
			<p>
		...
		<div class="col-md-12 feature-list">
			...
			<h4 class="title">Track your Project</h4>
			<p>
