  ...
  <div class="header-seperation"> 
    <ul class="nav pull-left notifcation-center" id="main-menu-toggle-wrapper" style="display:none">  
     <li class="dropdown"> <a id="main-menu-toggle" href="#main-menu"  class="" > <div class="iconset top-menu-toggle-white"></div> </a> </li>     
      ...
      <!-- BEGIN LOGO --> 
      <a href="index-2.html"><img src="/public/assets/img/logo.png" class="logo" alt=""  data-src="/public/assets/img/logo.png" data-src-retina="/public/assets/img/logo2x.png" width="106" height="21"/></a>
      <!-- END LOGO --> 
   ...
   <!-- BEGIN CHAT TOGGLER -->
    ...
    <div class="chat-toggler">  
        ...
        <div class="profile-pic"> 
          <img src="/public/assets/img/profiles/avatar_small.jpg"  alt="" data-src="/public/assets/img/profiles/avatar_small.jpg" data-src-retina="/public/assets/img/profiles/avatar_small2x.jpg" width="35" height="35" /> 
        </div>            
      </div>
