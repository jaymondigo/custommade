    ...
    <div class="container">
        ...
        <div class="row login-container column-seperation">
            ...
            <div class="col-md-6 col-md-offset-3"> <br>
                ...
                <form id="signup-form" name="signup_form" class="login-form" action="{{{ (Confide::checkAction('UserController@store')) ?: URL::to('user')  }}}" accept-charset="UTF-8" method="post" style="margin-left: 80px;">
                        ...
                        <div class="form-group col-md-10" ng-class="{'has-error': signup_form.email.$invalid && signup_form.email.$dirty}">
                            ...
                            <div class="controls">
                                <div class="input-with-icon  right">
                                    <i class=""></i>
                                    <input autocomplete="off" ensure-unique="email" type="email" required name="email" ng-model="email" id="txtusername" class="form-control" placeholder="Enter email" value="{{Input::old('email')}}">
                                    <div class="error" 
                    ...
                    <div class="row" >
                        <div class="form-group col-md-10" ng-class="{'has-error': signup_form.first_name.$invalid && signup_form.first_name.$dirty}">
                            ...
                            <div class="controls">
                                <div class="input-with-icon  right">
                                    <i class=""></i>
                                    <input autocomplete="off" type="text" required name="first_name" ng-model="first_name" id="txtusername" class="form-control" placeholder="Enter First name" value="{{Input::old('firstname')}}">
                                    <div class="error" 
                    ...
                    <div class="row" >
                        <div class="form-group col-md-10" ng-class="{'has-error': signup_form.last_name.$invalid && signup_form.last_name.$dirty}">
                            ...
                            <div class="controls">
                                <div class="input-with-icon  right">
                                    <i class=""></i>
                                    <input autocomplete="off" type="text" required name="last_name" ng-model="last_name" id="txtusername" class="form-control" placeholder="Enter Last name" value="{{Input::old('last_name')}}">
                                    <div class="error" 
                    ...
                    <div class="row">
                        <div class="form-group col-md-10" ng-class="{'has-error': signup_form.password.$invalid && signup_form.password.$dirty}">
                            ...
                            <div class="controls">
                                <div class="input-with-icon  right">
                                    <i class=""></i>
                                    <input autocomplete="off" type="password" required ng-model="password" name="password" ng-model="password" id="txtpassword" class="form-control"  placeholder="Enter password">
                                    <div class="error" 
                     ...
                     <div class="row">
                        <div class="form-group col-md-10" ng-class="{'has-error': signup_form.confirm_password.$invalid && signup_form.confirm_password.$dirty}">
                            ...
                            <div class="controls">
                                <div class="input-with-icon right">
                                    <i class=""></i>
                                    <input autocomplete="off" type="password" required data-password-verify='password' ng-model="password_verify" name="confirm_password" id="txtpassword" class="form-control"  placeholder="Confirm password">  
                    ...
                    <div class="row">
                        <div class="control-group  col-md-10" ng-class="{'has-error': signup_form.term.$error.dirty}">
                            <div class="checkbox checkbox check-success" data-toggle="tooltip" title="Please accept our terms and agreement" data-placement="bottom" data-original-title="Please accept our terms and agreement"> &nbsp;&nbsp;
                                <input autocomplete="off" type="checkbox" id="checkbox1" name="term" ng-model="term" value="1" required>
                    ...
                    <div class="row">
                        <div class="col-md-12" style="margin-left: 40px;">
                            <span><a href="user/login">Already have an account? Login</a> · <a href="">Want to be a maker?</a></span>
                        </div>
                    </div>
                </form>
                <div class="row">
