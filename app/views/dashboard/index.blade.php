...
@section('body')
<!-- body attr-->
@section('body_attr')class='document-body login error-body no-top' ng-app="dash_app"
@stop
<!-- body attr-->
<!-- Wrapper -->
     ...
     <!-- BEGIN CHAT TOGGLER -->
      <div class="pull-right"> 
        <div class="chat-toggler">  
         ...
         <ul class="nav quick-section " style="margin-left:0px !important;">
            <li class="quicklinks"> 
...
<div class="page-container row"> 
  ...
  <!-- BEGIN MINI-PROFILE -->
   <div class="user-info-wrapper">  
    ...
    <div class="user-info" style="margin-top: 17px;">
      <div class="username">Coby<span class="semi-bold"> Go</span></div>
      <div class="status"><a href="edit_account.html"><i class="icon-user"></i>&nbsp;&nbsp;Edit Account</a></div>
    </div>
   </div>
  <!-- END MINI-PROFILE -->
  ...
  <!-- BEGIN MINI-WIGETS -->
   ...
   <!-- BEGIN SIDEBAR MENU -->  
    ...
    <ul>    
      ...
      <li class=""> <a href="reviews.html"> <i class="icon-flag"></i>  <span class="title">Reviews</span></a></li>    
      <li class=""> <a href="proposals.html"> <i class="icon-reply"></i>  <span class="title">Proposals</span></a></li>      
      <li class=""> <a href="create_project.html"> <i class="icon-reply"></i>  <span class="title">create project</span></a></li>      
      <li class=""> <a href="edit_project.html"> <i class="icon-reply"></i>  <span class="title">edit project</span></a></li>      
      <li class=""> <a href="view_project.html"> <i class="icon-reply"></i>  <span class="title">view project</span></a></li>      
      <li class=""> <a href="project_activity.html"> <i class="icon-reply"></i>  <span class="title">project activity</span></a></li>      
      <li class=""> <a href="favorite.html"> <i class="icon-reply"></i>  <span class="title">Favorites</span></a></li>      
      <li class=""> <a href="search.html"> <i class="icon-reply"></i>  <span class="title">Search Results</span></a></li>      
      <li class=""> <a href="makers-profile.html"> <i class="icon-reply"></i>  <span class="title">Makers Profile</span></a></li>      
